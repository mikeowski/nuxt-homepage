    ...
    <div class="space-y-20">
        ...
        >
            <div>
                ...
                <div class="pt-32">
                    <p
                        class="description text-center text-xl font-bold opacity-0"
                    >
                        Merhaba ben Burak Mike {{ ageCalculator() }} yaşında,
                        <br />developer ve aynı zamanda Akdeniz Üniversitesi'nde
                        öğrenciyim.<br />
                        <br />Front-end teknolojileri ve tasarım araçları gibi
                        konularla <br />yakından ilgileniyorum.<br />
        ...
        >
            <arrow-down-white
                class="animate-bounce opacity-0 dark:opacity-100"
            />
